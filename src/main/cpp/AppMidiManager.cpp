 ...
 */
void Java_com_mathis_aeolusnative_hardwareMidi_AppMidiManager_startReadingMidi(
 ...
 */
void Java_com_mathis_aeolusnative_hardwareMidi_AppMidiManager_stopReadingMidi(JNIEnv*,
                                                                jobject) {
 ...
 */
JNICALL void Java_com_mathis_aeolusnative_hardwareMidi_AppMidiManager_initNative(
        JNIEnv* env, jobject instance) {
    env->GetJavaVM(&theJvm);

    // Setup the receive data callback (into Java)
    jclass clsAppMidiManager =
            env->FindClass("com/mathis/aeolusnative/hardwareMidi/AppMidiManager");
